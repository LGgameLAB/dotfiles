...
static const char *fonts[]          = {"Terminus:size=12"};//{ "hack-nerd:size=11", "monospace:size=10" };
...
static const char col_darkblue[]    = "#0f1236";
// static const char col_darkblue[]    = "#23f688";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_mauve, col_crust, col_base},
	[SchemeSel]  = { col_green, col_base,  col_mantle},
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_crust, "-nf", col_mauve, "-sb", col_base, "-sf", col_green, NULL };
static const char *roficmd[] = { "rofi", "-show", "drun", NULL};
static const char *termcmd[]  = { "st", NULL };
static const char *calccmd[]  = { "st -e sh -c 'mucalc; exec sh'", NULL };
...
static const char *audioupcmd[] = { "pactl", "set-sink-volume",  "@DEFAULT_SINK@",  "+5%", NULL};
static const char *audiodowncmd[] = { "pactl", "set-sink-volume",  "@DEFAULT_SINK@",  "-5%", NULL};
